...
for pfam_aim in tqdm(real_names):
    ...
    sns.histplot(length,
                 ...
                 color='green',
                 alpha=0.3,)
    pic_save_path = pjoin('pfam_data_process', pfam_aim, pfam_aim + clus_coef + '_dist_all.png')
    ...
    sns.histplot(sigma3_length,
                 ...
                 color='green',
                 alpha=0.3,)
    pic_save_path = pjoin('pfam_data_process', pfam_aim, pfam_aim + clus_coef + '_dist_3sigma.png')
    plt.savefig(pic_save_path)
    plt.close()
    print_log.close()
